...
6. Scene Delegate - 반복문 for문을 사용하여 배열이 있는 동안, 해당 배열을 append하도록 했다. 또한, 화면이 활성화 된 순간 네트워킹을 진행하면 viewModel에 데이터가 바로 반영되지 않는 문제점을 발견했다. 또한 url 데이터를 공유하는 작업은, 사파리나 크롬과 같은 외부 앱에서 하는 작업이므로 앱이 백그라운드에 진입할 수 밖에 없음을 고려하여 시점을 sceneDidEnterBackground()으로 변경했다.
<img width="820" alt="image" src="https://user-images.githubusercontent.com/126672733/235280074-f829265e-f6c6-4cac-b5b2-40470b43284c.png">
